...
<div class="dashboard__sidebar bg-white scroll-bar-1">
    ...
    <div class="sidebar__user text-center mb-20">
        <div class="logo">
            ...
            @endif
            <div style="position:absolute; margin-top:-41px; margin-left:132px;">
              <img src="{{asset('images/editbutton.png')}}" width="30px"/>
            </div> --}}
            <div class="row items-center upload-btn-wrapper">
                <div class="col-auto" style="margin:0px auto;">
                    {{-- <div class="d-block"> --}}
                        {{-- @php dd($dataUser->avatar_id) @endphp --}}
                        <img class="image-demo avatar avatar-cover" src="{{ asset('images/avatar/'.$dataUser->avatar_id) ?? $dataUser->getAvatarUrl() ?? ""}}"/>
                    {{-- </div> --}}
                    <div style="margin-top:-41px; margin-left:85px;">
                        <img src="{{asset('images/editbutton.png')}}" width="30px" onclick="document.querySelector('.button.h-50.px-24.-dark-1.bg-blue-1.text-white.btn-file input[type=file]').click()">
                    </div>
                </div>
                <div class="col-auto d-none">
                    ...
                    <div class="d-inline-block">
                        <button class="button h-50 px-24 -dark-1 bg-blue-1 text-white btn-file">
                           <input onchange="this.form.submit()" type="file" name="avatarImg">
                        </button>
                    </div>
