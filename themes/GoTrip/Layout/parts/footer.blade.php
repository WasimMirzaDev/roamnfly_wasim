...
?>
<section class="d-none layout-pt-md layout-pb-md mailchimp {{ $mailchimp_classes }} @if((!empty($row) && !empty($row->disable_subscribe_default) ) || !empty($disable_subscribe_default)) d-none @endif">
    <div class="container">
