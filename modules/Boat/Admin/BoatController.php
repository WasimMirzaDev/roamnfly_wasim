...
class BoatController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'        => __("holiday trip Management")
        ];
    ...
    public function recovery(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'        => __("Recovery holiday trip Management")
        ];
        return view('Boat::admin.index', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            ...
            'breadcrumbs'  => [
                ...
                [
                    'name'  => __('Add holiday trip'),
                    'class' => 'active'
                ],
            ],
            'page_title'   => __("Add new holiday trip")
        ];
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($res) {
            ...
            if ($id > 0) {
                ...
                return back()->with('success', __('holiday trip updated'));
            } else {
                event(new CreatedServicesEvent($row));
                return redirect(route('boat.admin.edit', $row->id))->with('success', __('holiday trip created'));
            }
        }
    }
